<script setup>
// Connectors — the connector manager control plane (comms channels to humans). Three sections:
...
<template>
  <div>
    <PageHeader
      title="Connectors"
      subtitle="Comms-channel connectors — the I/O channels the assistant uses to talk to humans"
    >
      <template #actions>
        <button
